...
flowchart LR
    ...
    Tools --> Scope[016 finance + technology scope]
```
...
| [016](016-finance-technology-conversation-scope.md) | Limit direct and web answers to finance and technology through the central router prompt |
