...
import { dialogAnimation, overlayFade } from "./motion-presets";
...
function DialogContent({
  ...
  open,
  ...props
}: React.ComponentProps<typeof DialogPrimitive.Content> & { noAnimation?: boolean; open?: boolean }) {
  if (noAnimation) {
    return (
        ...
        {open && (
          <>
            <DialogPrimitive.Overlay forceMount asChild>
              <motion.div key="overlay" className="ui-dialog-overlay" {...overlayFade} />
            ...
            <DialogPrimitive.Content forceMount asChild {...props}>
              <motion.div
                ...
                transition={dialogAnimation.transition}
              >
                {children}
                <DialogPrimitive.Close className="ui-dialog-close" aria-label="Close"><X size={17} /></DialogPrimitive.Close>
              </motion.div>
